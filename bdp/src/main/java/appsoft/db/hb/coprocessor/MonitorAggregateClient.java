...
public class MonitorAggregateClient {
	private static final Log log = LogFactory.getLog(MonitorAggregateClient.class);
	  Configuration conf;
	   ...
	   * @param cfg
	   */
	  public MonitorAggregateClient(Configuration cfg) {
	    this.conf = cfg;
	  }
