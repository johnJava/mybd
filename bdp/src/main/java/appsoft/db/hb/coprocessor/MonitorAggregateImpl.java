package appsoft.db.hb.coprocessor;
...
public class MonitorAggregateImpl <T, S, P extends Message, Q extends Message, R extends Message> 
extends AggregateService implements CoprocessorService, Coprocessor{

	 protected static final Log log = LogFactory.getLog(MonitorAggregateImpl.class);
