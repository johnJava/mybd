    ...
    <script type="text/javascript">  
        ...
        var console = {log : function(text) {
        	    if(text.indexOf("query") != -1){
        	    	query.innerHTML = text.substring(text.indexOf("query")+"query".length);
        	    }else if(text.indexOf("avrtime") != -1){
        	    	avrtime.innerHTML = text.substring(text.indexOf("avrtime")+"avrtime".length);
        	    }else{
            		infoPanel.innerHTML = text + "<br>"+infoPanel.innerHTML ;
        	    }
        	}};  
        // WebSocket演示对象  
        var demo = {  
